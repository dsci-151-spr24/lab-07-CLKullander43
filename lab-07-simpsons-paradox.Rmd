...
**Observational, as they did not assign people to specific treatment groups or roles.**

2.  How many observations are in this dataset?
    What does each observation represent?

**There are `r nrow(Whickham)` observations.**
...
**There are `r ncol(Whickham)` variables. Both `outcome` and `smoker` are character data that are two level ractors. `age` is numerial.**
...
**I expect that smokers are more likely to be dead.**
...
**This is surprising. These results imply that smokers are more likely to live longer.**
...
**The plot implies that smokers have a higher chance of being dead in each age category.**
